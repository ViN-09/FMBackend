...
class data_potensi extends Controller
{
    ...
    AVG(kw_rec1_2_ups2) as kw_rec1_2_ups2,
    AVG(kva_rec1_2_ups2) as kva_rec1_2_ups2,
    AVG(kw_rec4_ups1) as kw_rec4_ups1,
    AVG(kva_rec4_ups1) as kva_rec4_ups1,
    AVG(kw_rec3_5) as kw_rec3_5,
    AVG(kva_rec3_5) as kva_rec3_5,
    AVG(kw_rec9_10_11_12) as kw_rec9_10_11_12,
    AVG(kva_rec9_10_11_12) as kva_rec9_10_11_12,
    ...
    AVG(pue) as pue
            ")
                ...
                $data = $query->select(
                    ...
                    DB::raw('AVG(kw_rec1_2_ups2) as kw_rec1_2_ups2'),
                    DB::raw('AVG(kw_rec4_ups1) as kw_rec4_ups1'),
