...
class reciver2 extends Controller
{
    ...
    public function avgDPM(Request $request)
{
    ...
    $query = "SELECT $avgColumns FROM cacepue_test";
    ...
    public function pushDPM($data)
    {
        try {
            ...
            // Jika insert berhasil, kosongkan tabel cacepue_test
            $this->removeCacheData('cacepue_test');
    ...
    public function removeCacheData($tableName)
    {
        try {
            ...
            $allowedTables = ['cacepue_test', 'per_minute_table']; // daftar tabel yang diizinkan
